...
library(readr)
#Filenamen anpassen
Daten_09_07 <- read_csv("Daten/Daten_n48.csv", 
...
data_ic_m <-subset(data_ishiharaclean, data_ishiharaclean$'Smartphone Nutzungserfahrung' == 'mittelmäßig')
...
data_m <-subset(data, data$'Smartphone Nutzungserfahrung' == 'mittelmäßig')
